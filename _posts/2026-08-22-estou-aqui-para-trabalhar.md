---
layout: post
title: "Estou aqui para trabalhar e não para fazer amigos"
subtitle: "Quando você passa mais horas com quem não escolheu do que com quem você gosta"
author:
  - "Eduardo N. S. R."
...
Dizer que "não se está ali para fazer amigos" é, na melhor das hipóteses, uma ingenuidade aritmética. Na pior, é uma declaração de guerra fria contra as próprias condições de sobrevivência emocional.

> 🔔 *Disclaimer*: Este é um post sobre relações humanas no ambiente de trabalho, e relações humanas são, por essência, um tema sensível. Não há nomes reais, não há identificação de setores ou instituições específicas. Qualquer semelhança com pessoas vivas ou mortas deveria ser plenamente evidente para elas mesmas e para quem as conhece, especialmente se o autor tiver tido a gentileza de fornecer seus nomes reais, o que não é o caso. Todos os eventos aqui descritos de fato aconteceram, embora ocasionalmente o autor tenha tomado certas, muito (muuuuuuuuito) pequenas, liberdades com a cronologia, porque esse é seu direito como Ser Humano.
...
A frase "estou aqui para trabalhar e não para fazer amigos" funciona, no fundo, como aquilo que Goedecke chama de *máximo local* [^8]: parece disciplina profissional, parece pragmatismo, parece maturidade emocional. Mas é só o conforto anestesiado de não precisar encarar a complexidade brutal de conviver com outros seres humanos durante décadas. É trocar o trabalho árduo de construir relações funcionais pelo isolamento voluntário. E isolamento, como qualquer engenheiro de redes sabe, é o que acontece quando um nó se desconecta do *cluster*: ele continua existindo, continua consumindo energia, mas deixa de participar de qualquer coisa relevante.

Freire escreveu que "ninguém educa ninguém, ninguém educa a si mesmo, os homens se educam entre si, mediados pelo mundo" [^6]. A frase vale para o trabalho com a mesma intensidade: ninguém trabalha sozinho de verdade, ninguém cresce profissionalmente isolado numa bolha hermeticamente fechada, e quem insiste em fingir que o ambiente de trabalho é uma ilha deserta povoada por um único náufrago produtivo está, no fundo, construindo as próprias grades.

A verdade desconfortável é que conviver é inevitável. Construir relações funcionais com colegas de trabalho não é um bônus simpático, não é um módulo opcional de autoajuda corporativa, não é *soft skill* decorativa para enfeitar currículo em processo seletivo. É uma necessidade de sobrevivência tão concreta quanto saber operar o sistema que está sob a própria responsabilidade. E quando essa convivência é ativamente sabotada, dia após dia, micro-agressão após micro-agressão, silêncio hostil após silêncio hostil, o custo recai sobre todo mundo: sobre quem sabota (que se isola cada vez mais no próprio veneno), sobre quem é sabotado (que paga com a saúde mental e com o prazer de trabalhar) e sobre a instituição (que perde, aos poucos, a capacidade de funcionar como deveria).
...
Não no sentido que qualquer consultor de RH entenderia como solução, pelo menos. Dinâmicas de grupo, treinamentos de liderança, facilitadores externos, conversas difíceis facilitadas por terceiros neutros: todas essas ferramentas têm valor real em ambientes onde o problema é de comunicação, de alinhamento de expectativas, de ruído interpessoal que pode ser reduzido com esforço e boa vontade. O que acontece quando o problema não é ruído, mas sinal? Quando os comportamentos destrutivos não são disfunções acidentais de um sistema que quer funcionar, mas a função deliberada de um sistema que foi construído para não funcionar?
...
A convivência não precisa ser calorosa. Não precisa ser amizade. Não precisa ser nada além de *funcional*, no sentido mais pragmático que essa palavra pode ter. Mas funcional exige esforço de ambos os lados, e quando um lado se recusa a exercer esse esforço, o outro lado tem a escolha, nunca fácil, de decidir quanto da própria energia vai gastar tentando construir uma ponte que vai continuar sendo demolida do outro lado.
...
[^2]: **A Organização Sem Medo: Criando Segurança Psicológica no Local de Trabalho para Aprendizado, Inovação e Crescimento** {*Amy Edmondson*} ([Link](https://www.amazon.com.br/Organiza%C3%A7%C3%A3o-Sem-Medo-Psicol%C3%B3gica-Aprendizado-ebook/dp/B08VMXC5CG))

[^3]: **Assédio Moral: A Violência Perversa no Cotidiano** {*Marie-France Hirigoyen*} ([Link](https://www.amazon.com.br/ASS%C3%89DIO-MORAL-viol%C3%AAncia-perversa-cotidiano/dp/8528607402?s=books))

[^4]: **Ciência e Comportamento Humano** {*B.F. Skinner*} ([Link](https://www.amazon.com.br/Ci%C3%AAncia-Comportamento-Humano-B-Skinner/dp/8533619359?s=books))

[^5]: **O Seminário, Livro 20: Mais, Ainda** {*Jacques Lacan*} ([Link](https://www.amazon.com.br/Semin%C3%A1rio-livro-20-Mais-ainda/dp/8571104913?s=books))

[^6]: **Pedagogia do Oprimido** {*Paulo Freire*} ([Link](https://www.amazon.com.br/Pedagogia-do-oprimido-Paulo-Freire-ebook/dp/B00I3PUV12))

[^7]: **Eichmann em Jerusalém: Um Relato sobre a Banalidade do Mal** {*Hannah Arendt*} ([Link](https://www.amazon.com.br/Eichmann-Jerusalem-Report-Banality-Evil-ebook/dp/B001RHOJSE?s=digital-text))

[^8]: **You should never be angry at work** {*Sean Goedecke*} ([Link](https://www.seangoedecke.com/you-should-never-be-angry-at-work/))

[^9]: **A Formação Social da Mente** {*Lev Vygotsky*} ([Link](https://www.amazon.com.br/Forma%C3%A7%C3%A3o-Social-Mente-desenvolvimento-psicol%C3%B3gicos/dp/8533622643))

[^10]: **O Ambiente e os Processos de Maturação: Estudos sobre a Teoria do Desenvolvimento Emocional** {*Donald Winnicott*} ([Link](https://www.amazon.com.br/Ambiente-Processos-Matura%C3%A7%C3%A3o-Desenvolvimento-Emocional/dp/8573074566?s=books))

[^11]: **O Juízo Moral na Criança** {*Jean Piaget*} ([Link](https://www.amazon.com.br/Ju%C3%ADzo-Moral-na-Crian%C3%A7a/dp/8532304575?s=books))

[^12]: **Microfísica do Poder** {*Michel Foucault*} ([Link](https://www.amazon.com.br/Microf%C3%ADsica-do-poder-Michel-Foucault/dp/6555480076?s=books))

[^13]: **A Máquina das Crianças: Repensando a Escola na Era da Informática** {*Seymour Papert*} ([Link](https://www.amazon.com.br/Maquina-das-Crian%C3%A7as-Seymour-Papert/dp/8536310588?s=books))
