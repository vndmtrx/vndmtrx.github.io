...
> [!TIP] Dica
> A compilação do Erlang leva alguns minutos porque o ASDF compila o código-fonte diretamente na sua máquina.
...
> [!WARNING] Aviso
> O nome da pasta no repositório de exemplos é `01-saudacao` para manter a organização sequencial dos posts, mas a estrutura e o código são rigorosamente os mesmos.
