...
Para os destaques primários (links e botões), usamos um ciano fechado (<span class="color-swatch" style="background:#007a8a;"></span>`#007a8a`) no tema claro para dar contraste firme sobre o branco, e um ciano mais elétrico (<span class="color-swatch" style="background:#78dce8;"></span>`#78dce8`) no tema escuro. O restante dos acentos segue a mesma lógica das canetas coloridas: vermelho para avisos críticos, amarelo para atenção e verde para confirmações.
