...
O roteiro detalhado dos 24 posts (Cluster Base, Integração, Operações e Extras) está em [references/roteiro.md](file:///home/rolim/du/dev/github/vndmtrx.github.io/.agents/skills/k8sbox-series/references/roteiro.md).
